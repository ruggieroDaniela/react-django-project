# Generated by Django 4.1.8 on 2023-06-05 15:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_user', models.CharField(choices=[('natural', 'Natural'), ('enterprise', 'Enterprise')], max_length=10)),
                ('country', models.CharField(max_length=128)),
                ('first_name', models.CharField(max_length=128, null=True)),
                ('last_name', models.CharField(max_length=128, null=True)),
                ('dni', models.CharField(max_length=128, null=True, validators=[django.core.validators.RegexValidator(code='dni_invalido', message='El campo debe ser una cédula de identidad o número de pasaporte', regex='^(([A-Z]-)[0-9]{1,3}\\.?[0-9]{1,3}\\.?[0-9]{1,3})$|^([A-Z]{1,3}[0-9]{6,7})$')])),
                ...
                ('date_joined', models.JSONField(default=users.models.User.get_date_joined)),
