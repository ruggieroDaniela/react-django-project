    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                ...
                const response = await axios.post(`${import.meta.env.DJANGO_API_URL}/users/get_name/`, {id: post.user});
                ...
                <section className='button-group' key={`post ${post.id} ${"self.crypto.randomUUID()"}`}>
                    <button
                        ...
                        onClick={ async () => {
                            ...
                            await axios.put(`${import.meta.env.DJANGO_API_URL}/api-services/${postType}/enable_post/${post.id}/`)
                            console.log("wtf");
                    ...
                    <button
                        disabled={ !(canEdit) }
                        onClick={ async () => {
                            await axios.delete(`${import.meta.env.DJANGO_API_URL}/api-services/${postType}/delete_post/${post.id}/`)
